        ...
        <div style={{ fontFamily: 'system-ui, -apple-system, sans-serif', margin: 0, padding: 0, backgroundColor: '#f8fafc', minHeight: '100vh', color: '#0f172a' }}>
            <header style={{ backgroundColor: '#1e293b', color: '#ffffff', padding: '1rem 2rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center', boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.1)' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '2rem' }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', borderLeft: '1px solid #334155', paddingLeft: '1rem' }}>
                        <span style={{ fontSize: '0.9rem', color: '#cbd5e1' }}>Hello, {user?.username}</span>
                        <button onClick={handleLogout} style={{ backgroundColor: 'transparent', color: '#f87171', border: '1px solid #f87171', padding: '0.4rem 0.8rem', borderRadius: '0.375rem', cursor: 'pointer', fontWeight: 600 }}>Logout</button>
                    </div>
                </div>
            </header>
